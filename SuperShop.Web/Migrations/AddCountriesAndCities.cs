    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                Id = table.Column<string>("nvarchar(450)",
                    nullable: false),
                Name = table.Column<string>("nvarchar(256)",
                    maxLength: 256, nullable: true),
                NormalizedName = table.Column<string>("nvarchar(256)",
                    maxLength: 256, nullable: true),
                ConcurrencyStamp =
                    table.Column<string>("nvarchar(max)",
                        nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                Id = table.Column<string>("nvarchar(450)",
                    nullable: false),
                FirstName = table.Column<string>("nvarchar(max)",
                    nullable: true),
                LastName = table.Column<string>("nvarchar(max)",
                    nullable: true),
                UserName = table.Column<string>("nvarchar(256)",
                    maxLength: 256, nullable: true),
                NormalizedUserName = table.Column<string>(
                    "nvarchar(256)", maxLength: 256, nullable: true),
                Email = table.Column<string>("nvarchar(256)",
                    maxLength: 256, nullable: true),
                NormalizedEmail = table.Column<string>(
                    "nvarchar(256)", maxLength: 256, nullable: true),
                EmailConfirmed =
                    table.Column<bool>("bit", nullable: false),
                PasswordHash = table.Column<string>("nvarchar(max)",
                    nullable: true),
                SecurityStamp = table.Column<string>("nvarchar(max)",
                    nullable: true),
                ConcurrencyStamp =
                    table.Column<string>("nvarchar(max)",
                        nullable: true),
                PhoneNumber = table.Column<string>("nvarchar(max)",
                    nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                WasDeleted =
                    table.Column<bool>("bit", nullable: false),
                Name = table.Column<string>("nvarchar(50)",
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                RoleId = table.Column<string>("nvarchar(450)",
                    nullable: false),
                ClaimType = table.Column<string>("nvarchar(max)",
                    nullable: true),
                ClaimValue = table.Column<string>("nvarchar(max)",
                    nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                Id = table.Column<int>("int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                OrderDate = table.Column<DateTime>("datetime2",
                    nullable: false),
                DeliveryDate = table.Column<DateTime>("datetime2",
                    nullable: true),
                UserId = table.Column<string>("nvarchar(450)",
                    nullable: false),
                WasDeleted =
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Price = table.Column<decimal>("decimal(18,2)",
                    nullable: false),
                ImageUrl = table.Column<string>("nvarchar(max)",
                    nullable: true),
                ImageId = table.Column<Guid>("uniqueidentifier",
                    nullable: false),
                ImageIdGcp = table.Column<Guid>("uniqueidentifier",
                    nullable: false),
                ImageIdAws = table.Column<Guid>("uniqueidentifier",
                    nullable: false),
                LastPurchase = table.Column<DateTime>("datetime2",
                    nullable: true),
                LastSale = table.Column<DateTime>("datetime2",
                    nullable: true),
                IsAvailable =
                    table.Column<bool>("bit", nullable: false),
                Stock =
                    table.Column<double>("float", nullable: false),
                UserId = table.Column<string>("nvarchar(450)",
                    nullable: false),
                WasDeleted =
                    table.Column<bool>("bit", nullable: false)
