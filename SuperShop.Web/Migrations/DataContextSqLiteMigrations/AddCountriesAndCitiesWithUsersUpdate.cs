    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                Id = table.Column<string>("TEXT", nullable: false),
                FirstName =
                    table.Column<string>("TEXT", maxLength: 50, nullable: true),
                LastName =
                    table.Column<string>("TEXT", maxLength: 50, nullable: true),
                Address = table.Column<string>("TEXT", maxLength: 100,
                    nullable: true),
                CountryId = table.Column<int>("INTEGER", nullable: false),
                CityId = table.Column<int>("INTEGER", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                Id = table.Column<int>("INTEGER", nullable: false)
                    .Annotation("Sqlite:Autoincrement", true),
                OrderDate = table.Column<DateTime>("TEXT", nullable: false),
                DeliveryDate = table.Column<DateTime>("TEXT", nullable: true),
                UserId = table.Column<string>("TEXT", nullable: false),
                WasDeleted = table.Column<bool>("INTEGER", nullable: false)
            },
            constraints: table =>
